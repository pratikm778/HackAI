...
class RAGGenerator:
    ...
    def _build_prompt(self, query: str, context: str) -> tuple:
        ...
        """
        system_prompt = """You are an AI assistant specialized in first explaining complicated financial terms and its impact 
        on the company's financial statements with increase or ecreasing value, typically these are ratios or other 
        financial metrics.
        Then you analyze and answer questions about corporate documents.
        After you provide the explanationm you need to relate the financial term to the provided companys(LTI MIndtre's) 10k report
        Use ONLY the information provided in the context below to answer the question. 
        If the context doesn't contain enough information to provide a complete answer, 
        acknowledge the limitations and answer based on what is available.
